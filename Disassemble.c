 ...
 *
 * Parameters:
 * *codebuffer - pointer for a portion of the Space Invaders ROM hex code, entered into a buffer to be processed.
 * pc - the offset added to signify which part of the buffer to access (where in the game code to read).
 */
...
int Disassemble8080Op(unsigned char *codebuffer, int pc) {
	...
	switch (*code) {
		...
		case 0x77: printf("MOV	H,A"); break;

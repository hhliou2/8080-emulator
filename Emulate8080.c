...
int Emulate8080Op(State8080* state) {
	...
	switch(*opcode) {
		...
		case 0x04: 
			   state->b = state->b + 1;
			   state->cc.z = flag_z(state->b);
			   state->cc.s = flag_s(state->b);
			   state->cc.p = flag_p(state->b);
			   break;
		case 0x05: 
			   state->b = state->b - 1;
			   state->cc.z = flag_z(state->b);
		...
		case 0x14: 
			   state->d += 1;
			   state->cc.z = flag_z(state->d);
			   state->cc.s = flag_s(state->d);
			   state->cc.p = flag_p(state->d);
			   break;
		case 0x15: 
			   state->d = state->d - 1;
			   state->cc.z = flag_z(state->d);
		...
		case 0x23: 
			   ...
			   break;
		case 0x24: state->h += 1;
			   state->cc.z = flag_z(state->h);
			   state->cc.s = flag_s(state->h);
			   state->cc.p = flag_p(state->h);
			   break;
		...
		case 0x2b: 
			   ...
			   break;
		case 0x2c: state->l += 1;
			   state->cc.z = flag_z(state->l);
			   state->cc.s = flag_s(state->l);
			   state->cc.p = flag_p(state->l);
			   break;
		...
		case 0x71: writeHL(state, state->c); break;
		...
		case 0xa0: state->a = state->a & state->b; 
